...
class ClientCurrentState extends StatefulWidget {
  final String? username;
  final String? code;
  ClientCurrentState({Key? key, @required this.username, @required this.code})
      : super(key: key);
...
class _CurrentStateState extends State<ClientCurrentState> {
